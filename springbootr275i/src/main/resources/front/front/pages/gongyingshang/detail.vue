...
<script>
	export default {
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','gongyingshang');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','gongyingshang');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('gongyingshang', this.id);
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussgongyingshang/add-or-update?refid=${this.id}`)
			},
			onSHTap() {

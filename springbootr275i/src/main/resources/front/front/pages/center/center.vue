	...
	<view class="content">
		<view :style='{"minHeight":"100vh","padding":"40rpx 0 240rpx","flexWrap":"wrap","background":"url() fixed,#fff","display":"flex","width":"100%","position":"relative","height":"auto"}'>
			<view :style='{"padding":"0px 24rpx","boxShadow":"inset 0px 0px 0px 0px #f7dcab","margin":"20rpx auto 160rpx","borderColor":"#e9be70","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20221221/b0090511ebb8453898dc32870d4b5bbd.png) no-repeat center top / 100% 100%,rgba(255,255,255,1)","borderWidth":"0px 0px 0px 0px","display":"flex","width":"calc(100% - 40rpx)","borderStyle":"solid","height":"280rpx","order":"2"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"width":"calc(100% - 112rpx)","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","height":"100%"}' v-if="tableName=='gongyingshang'" class="userinfo">
					...
					<view :style='{"width":"70%","flexDirection":"column","justifyContent":"center","display":"flex","height":"100%"}' class="info">
						<view :style='{"padding":"4rpx 8rpx","borderColor":"#eee","margin":"0 0 0px","color":"#333","borderWidth":"0 0 2rpx","width":"90%","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>{{user.gongyingzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
				<view :style='{"width":"calc(100% - 112rpx)","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","height":"100%"}' v-if="tableName=='yuangong'" class="userinfo">
					<image :style='{"padding":"0","margin":"0 0px 0 0","borderRadius":"16rpx","objectFit":"cover","textAlign":"center","background":"#000","width":"30%","height":"60%","order":"2"}' :src="user.zhaopian?baseUrl+user.zhaopian:'/static/gen/upload.png'"></image>
					<view :style='{"width":"70%","flexDirection":"column","justifyContent":"center","display":"flex","height":"100%"}' class="info">
						<view :style='{"padding":"4rpx 8rpx","borderColor":"#eee","margin":"0 0 0px","color":"#333","borderWidth":"0 0 2rpx","width":"90%","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>{{user.yuangonggonghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
				</view>
